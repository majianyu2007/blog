...
function welcome() {
	console.log('Welcome to majianyu.site! You\'re chatting with other people who visited ' + domain + ' and opened their browser\'s console! Type help() and hit enter to learn more.');
...
function loadMessages() {
	var myRequest = new Request('https://majianyu.site/api/read.php?domain=' + domain);
	fetch(myRequest)
...
function send(message, color = '000000') {
	...
	var myRequest = new Request('https://majianyu.site/api/send.php');
	if (usernameLS === null) {
